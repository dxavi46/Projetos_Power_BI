-- === QUERIES PARA MODELAGEM RELACIONAL ===
-- Quantos pedidos foram feitos por cada cliente
-- Total de vendas por mês
-- Relação de produtos, fornecedores e estoque
-- Relação de nomes dos fornecedores, nomes dos produtos e estoque atual por produto
...
SELECT 
    c.customer_id,
    CASE 
        WHEN c.customer_type = 'PF' THEN CONCAT(c.first_name, ' ', c.last_name)
        ELSE c.company_name
    END AS cliente,
